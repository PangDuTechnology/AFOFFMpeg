#
#  Be sure to run `pod spec lint AFOUIKIT.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "PangDu"
  # s.authors            = { "PangDu" => "xian312117@gmail.com" }
  # s.social_media_url   = "http://twitter.com/PangDu"
  ...
  s.public_header_files = "AFOFFMpeg/**/*.h","AFOFFMpeg/libyuv/libyuv.h","AFOFFMpeg/libyuv/include/*.h"
